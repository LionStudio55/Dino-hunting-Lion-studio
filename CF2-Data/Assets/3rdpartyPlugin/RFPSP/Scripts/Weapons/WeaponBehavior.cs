    ...
    void HitObject(RaycastHit hit, Vector3 directionArg, bool isSecondCast = false)
    {
        ...
        switch (hit.collider.gameObject.layer)
        {
            ...
            case 13://hit object's layer is an NPC
                    ...
                    //{
                if (hit.collider.gameObject.GetComponent<Hit_Body>() && MissionHandler.ins.Total_TargetCount - DamageManager.KilledAnimal != 1/* UI_Manager.instance.kills[Constants.Getprefs(Constants.lastselectedLevel)] - DamageManager.KilledAnimal != 1*/)
                {
                ...
                else if (hit.collider.gameObject.GetComponent<Hit_Head>() && MissionHandler.ins.Total_TargetCount - DamageManager.KilledAnimal != 1/*UI_Manager.instance.kills[Constants.Getprefs(Constants.lastselectedLevel)] - DamageManager.KilledAnimal != 1*/)
                {
                ...
                else if (hit.collider.gameObject.GetComponent<Hit_Body>() && MissionHandler.ins.Total_TargetCount - DamageManager.KilledAnimal == 1)
                {
                    if (Gunhasslomo)
                    {
                ...
                else if (hit.collider.gameObject.GetComponent<Hit_Head>() && MissionHandler.ins.Total_TargetCount - DamageManager.KilledAnimal == 1)
                {
                    if (Gunhasslomo)
                    {
                        muzzleFlash.gameObject.SetActive(false);
