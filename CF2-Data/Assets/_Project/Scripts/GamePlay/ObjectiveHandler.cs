...
//			print ("i: "+i+" and order: "+LevelsOrder[i]);
		...
		currentLevel = Constants.Getprefs(Constants.lastselectedLevel);
    ...
    {
        if (Constants.Getprefs(Constants.lastselectedLevel) <= 5)
        {
            Timer.timemanager.time = 80 * Enemies;
        }
        else if (Constants.Getprefs(Constants.lastselectedLevel) > 5 && Constants.Getprefs(Constants.lastselectedLevel) < 11)
        {
            Timer.timemanager.time = 60 * Enemies;
        }
        else if (Constants.Getprefs(Constants.lastselectedLevel) >= 11)
        {
