...
public class Emerald_Animal_AI : MonoBehaviour
{
    ...
    public float fleeRangeMin = 25;
    public float fleeRangeMax = 30;
    ...
    {
        isGrazing = false;
        // flee point range set
        // this is the editid code by KJAY
        float xValue = 0f;
        float zValue = 0f;
        int choseNO = Random.Range(0, 4);
        switch (choseNO)
        {
            case 0:
                xValue = Random.Range(fleeRangeMin, fleeRangeMax);
                zValue = Random.Range(fleeRangeMin, fleeRangeMax);
                break;
            case 1:
                xValue = Random.Range(fleeRangeMin, fleeRangeMax);
                zValue = Random.Range(-fleeRangeMin, -fleeRangeMax);
        ...
        destination = destination + new Vector3(xValue, 0, zValue);
