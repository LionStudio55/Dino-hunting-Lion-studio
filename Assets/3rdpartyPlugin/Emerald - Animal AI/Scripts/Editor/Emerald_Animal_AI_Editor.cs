...
public class Emerald_Animal_AI_Editor : Editor 
{
	...
	public override void OnInspectorGUI () 
	{
		...
		*/
		...
		if (self.aggression == 1)
		{
			...
			EditorGUILayout.LabelField("Minmum and maximum range of flee");
			EditorGUILayout.MinMaxSlider(ref self.fleeRangeMin,  ref self.fleeRangeMax, 20f, 200f);
	...
	void OnSceneGUI () 
	{
		...
		if (self.aggression == 1 && self.useVisualRadius)
		{
			...
			Handles.DrawSolidDisc(self.transform.position, Vector3.up, self.fleeRangeMax);
		}
