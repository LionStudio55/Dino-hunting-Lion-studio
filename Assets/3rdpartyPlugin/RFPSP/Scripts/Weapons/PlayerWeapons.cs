...
public class PlayerWeapons : MonoBehaviour
{
    ...
    public static PlayerWeapons ins;
    ...
    void Start()
    {
        ...
        //{
        //    weaponOrder[9].GetComponent<WeaponBehavior>().haveWeapon = true;
        ...
        //    selected_weapon();
        //}
        currentWeapon = Constants.Getprefs(Constants.LastSelectedGun)+1;
        selected_weapon();
    ...
    void selected_weapon()
    {
        weaponOrder[currentWeapon/*Constants.Getprefs(Constants.LastSelectedGun) + 1*/].GetComponent<WeaponBehavior>().haveWeapon = true;
        StartCoroutine(SelectWeapon(currentWeapon/*Constants.Getprefs(Constants.LastSelectedGun) + 1*/));
        Cheeck_unlockall();
      //  print("Gun Index:" + currentWeapon);

        //if (PlayerPrefs.GetInt("trail") == 0)
        //{
        //    if (Constants.TryWeapon)
        //    {
        //        weaponOrder[Constants.Getprefs(Constants.LastSelectedGun) + 1].GetComponent<WeaponBehavior>().haveWeapon = true;
        //        StartCoroutine(SelectWeapon(Constants.Getprefs(Constants.LastSelectedGun) + 1));
        //        Cheeck_unlockall();
        //    }
        //    else
        //    {
        ...
        //else
        //{
        //    if (Constants.Getprefs(Constants.lastselectedLevel) == 1)
        //    {
        //        weaponOrder[8].GetComponent<WeaponBehavior>().haveWeapon = true;
        ...
        //    {
        //        weaponOrder[10].GetComponent<WeaponBehavior>().haveWeapon = true;
        //        StartCoroutine(SelectWeapon(10));
        //        Cheeck_unlockall();
        //    }
        //    else if (Constants.Getprefs(Constants.lastselectedLevel) == 5)
        //    {
    ...
    public void Secondaryweapon()
    {
        ...
        {
            index = 0;
            weaponno = Constants.Getprefs(Constants.LastSelectedGun) + 1;
        }
        weaponOrder[weaponno].GetComponent<WeaponBehavior>().haveWeapon = true;
        StartCoroutine(SelectWeapon(weaponno));
        Cheeck_unlockall();
    }
    void Cheeck_unlockall()
    {
        for (int i = 0; i < weaponOrder.Length; i++)
        {
            weaponOrder[i].GetComponent<WeaponBehavior>().haveWeapon = true;
        }
        ...
        //{
        //    weaponOrder[6].GetComponent<WeaponBehavior>().haveWeapon = true;
